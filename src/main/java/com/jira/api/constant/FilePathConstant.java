...
public class FilePathConstant {
    ...
    public static final String CREATE_FILTER_SCHEMA_FILEPATH = JSON_SCHEMA + "create_filter_response_json_schema.json";
    public static final String GET_FILTER_SCHEMA_FILEPATH = JSON_SCHEMA + "get_filter_response_json_schema.json";
